...
<a class="external reference" href="https://github.com/thln2ejz/bash_projects/blob/master/subset">subset</a>: tool for transposing or slicing a dataframe given in a CSV file. Subsetting can be done via row(s) and/or column(s). It also supports an option for dropping rows and/or columns instead.
