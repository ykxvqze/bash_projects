...
result="$("${csvchk}" "${src_dir}"/file_space_in_element.csv)"
...
result="$("${csvchk}" "${src_dir}"/file_long_row.csv)"
...
result="$("${csvchk}" "${src_dir}"/file_short_row.csv)"
...
result="$("${csvchk}" "${src_dir}"/file_empty_value.csv)"
